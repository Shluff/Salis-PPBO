...
public class Toko {
    ...
    private Gudang gudangBarang;
        ...
        public void selesaikanAntrian() {
            ...
            for (Pembeli pembeli : antrian) {
                if (barangDiBeliTersedia(pembeli)) {
                    isiGudang.put(pembeli.getBarangDiBeli(), isiGudang.get(pembeli.getBarangDiBeli()) - pembeli.getJumlahBarang());
                    antrianSelesai.add(pembeli);
                    System.out.println(pembeli.getJumlahBarang() + " " + pembeli.getBarangDiBeli() + " berhasil dikeluarkan dari gudang");
                }
            }
        ...
        public void cekIsiAntrian() {
            System.out.println("\n List Antrian:");
            for (Pembeli pembeli : antrian) {
                System.out.println("antrian ke " + (antrian.indexOf(pembeli) + 1) + ", nama : " + pembeli.getNama() + ", barang di beli " + pembeli.getBarangDiBeli() + ", jumlah barang di beli : " + pembeli.getJumlahBarang());
            }
        }
